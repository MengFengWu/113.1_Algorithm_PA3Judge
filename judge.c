...
int rec[100] = {-76906, -76906, -59569, -428889, -376002, -328558, -184616, -141658, -285555, -107964, -101420, -316910, -242145, -224504, -208116, -141850, -164741, -241567, -135203, -155912, -174632, -190035, -211827, -128482, -92160, -330616, -190113, -199711, -184778, -227492, -211713, -257126, -209468, -255017, -250243, -132724, -100573, -129859, -341113, -250065, -352567, -156372, -181924, -333761, -104067, -74663, -213658, -398451, -236980, -353763, -106280, -150499, -233852, -160897, -325669, -352249, -331813, -332432, -147599, -307300, -225329, -218784, -254718, -115999, -185886, -342247, -90666, -140639, -275595, -281101, -268310, -7223, -225762, -166594, -377467, -229814, -222269, -265090, -9127, -158448, -103197, -276061, -211741, -301194, -216715, -246673, -211147, -355013, -263573, -186254, -139423, -252379, -149364, -321186, -206267, -136944, -291853, -127621, -286464, -143248};
int type = 0;
int testcase = 0;
...
void unreachable() {
    printf("\033[0;31mWA: Some vertices unreachable\033[0m\n");
}
...
void reachableAux(int index, int n) {
    reach[index] = 1;
    for(int i = 0; i < n; i++) {
        if(adjM[index][i] == 1 || adjM[i][index] == 1) {
            if(reach[i] == 0) {
                reachableAux(i, n);
            }
        }
...
void testcaseDW(int num, int n, int m, int seed) {
    ...
    if(fork() == 0) {
        ...
        else if(answer > rec[seed]){
            printf("\033[0;34mPrivate Case %d: Performance: %d.\033[0m\n", num, answer);
        }
        else {
            printf("\033[0;32mPrivate Case %d: Performance: %d.\033[0m\n", num, answer);
        }
...
int main(int argc, char* argv[]) {
    ...
    if(va == -1) {
        ...
        if(cat2 > 10000) cat2 = 10000;
        testcaseDW(0, cat1, (cat2 > (cat1 - 1) ? cat2 : (cat1 - 1)), seed);
    }
    return 0;
}